...
--     -- 1. 將用戶`李燕容`新增為教練，並且年資設定為2年（提示：使用`李燕容`的email ，取得 `李燕容` 的 `id` ） lee2000@hexschooltest.io
--     -- 2. 將用戶`肌肉棒子`新增為教練，並且年資設定為2年 muscle@hexschooltest.io
--     -- 3. 將用戶`Q太郎`新增為教練，並且年資設定為2年 starplatinum@hexschooltest.io
